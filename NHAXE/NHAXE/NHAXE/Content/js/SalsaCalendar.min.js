!function(t,e){
	"object"==typeof exports&&"object"==typeof module?module.exports=e():"function"==typeof define&&define.amd?define("SalsaCalendar",[],e):"object"==typeof exports?exports.SalsaCalendar=e():t.SalsaCalendar=e()}
	(this,function(){
		return function(t){
			function e(i){
		...
		([function(t,e,n){t.exports=n(3)},
			...
			function(t,e){
				...
				n.getElementsByClassName=function(t,e){
					for(var n=t.getElementsByTagName("*"),i=[],a="(^|\\s)"+e+"(\\s|$)",s=0;s<n.length;s++){
						var r=n[s];
						r.className.match&&r.className.match(a)&&(i[i.length]=r)}
						return i},
				n.elementHasClass=function(t,e){
					var n=t.className.split(" ");
					return n.indexOf(e)!==-1},
				n.findElementPosition=function(t){
					for(var e=0,n=0;t;)e+=t.offsetLeft,n+=t.offsetTop,t=t.offsetParent;return{left:e,top:n}},
				n.isElementVisible=function(t){var e=t.offsetWidth,
					n=t.offsetHeight;
					return(0!==e||0!==n)&&(e>0&&n>0||"none"!==t.display)},
				n.getEvent=function(t){
					return t||window.event},
				n.getEventTarget=function(t){
					return t=n.getEvent(t),t.target||window.event.srcElement},
				n.addEvent=function(t,e,n){
					t.addEventListener?t.addEventListener(e,n,!1):t.attachEvent&&t.attachEvent("on"+e,n)},
				n.isMobile=function(){
					var t=window.innerWidth>0?window.innerWidth:screen.width;return t<=480},
				t.exports=n
			},
		function(t,e){},function(t,e,n){"use strict";function i(t){
			void 0===t.lang&&(t.lang="en"),
			void 0===t.yearsNavigation&&(t.yearsNavigation=!1),
			void 0===t.range&&(t.range={min:!1,max:!1,weekdays:!1,closing_dates:!1}),
			void 0===t.range.min&&(t.range.min=!1),void 0===t.range.max&&(t.range.max=!1),
			void 0===t.ranges&&(t.ranges=[t.range]),void 0===t.minDate&&(t.minDate=!1),
			void 0===t.allowEmptyDate&&(t.allowEmptyDate=!1),
			void 0===t.inputReadOnly&&(t.inputReadOnly=!1),
			void 0===t.showNextMonth&&(t.showNextMonth=!1),
			r.isMobile()&&(t.showNextMonth=!1),
			void 0===t.onSelect&&(t.onSelect=function(t){}),
			void 0===t.calendarPosition&&(t.calendarPosition="bottom"),
			void 0===t.fixed&&(t.fixed=!1),void 0===t.dateFormats&&(t.dateFormats={}),
			void 0===t.scrollableContainerElement&&(t.scrollableContainerElement=null),
			this.options=t,this.calendar=null,
			this.other_calendar=null,
			this.current_date=null,
			this.on_set_current_date_closures=[],
			this.on_date_click=function(){},
			this.before_show=function(){},
			this.i18n=new a(this,this.options.lang,t.dateFormats),
			this.input=new s(this,this.options.inputId,this.options.allowEmptyDate,this.options.inputReadOnly||r.isMobile()),
			null!==this.options.scrollableContainerElement?this.scrollable_container=this.options.scrollableContainerElement:this.scrollable_container=document.body,
			this._init_events(),
			his._init_options()
		}
			var a=n(5),
			...
			n(8),
			n(2),
			i.prototype={_init_options:function(){
					for(var t=0;t<this.options.ranges.length;t++)"today"===this.options.ranges[t].min&&(this.options.ranges[t].min=this.i18n.date2DateString(new Date))},
				_init_events:function(){
					r.addEvent(document,"click",function(t){
						var e=r.getEventTarget(t);this._is_calendar_element(e)||this.hide()}.bind(this))},
				_is_calendar_element:function(t){
					if(t===this.input.getElement())return!0;
					if(r.elementHasClass(t,"sc-keep-open"))return!0;
					for(;t.parentNode;){
						if(t===this.calendar)return!0;if(r.elementHasClass(t,"salsa-calendar-input"))return!0;t=t.parentNode
					}return!1},
				onSetCurrentDate:function(t){
					this.on_set_current_date_closures.push(t)},
				onDateClick:function(t){
					this.on_date_click=t
				},
				beforeShow:function(t){
					this.before_show=t
				},
				setOtherCalendar:function(t){
					this.other_calendar=t
				},
				setCurrentDate:function(t){
					this.current_date=t;
					for(var e=0;e<this.on_set_current_date_closures.length;e++)this.on_set_current_date_closures[e]()
				},
				getCurrentDate:function(){
					return this.current_date
				},
				selectDate:function(t){
					this.input.setDate(t),
					this.input.checkAndValidateDate()&&(this.setCurrentDate(t),
						this.show(t.getFullYear(),t.getMonth()))
				},
				setRangeMin:function(t){
					var e=this.i18n.dateString2Date(t);
					null!==e&&(this.options.range.min=t)
				},
				setRangeMax:function(t){
					var e=this.i18n.dateString2Date(t);
					null!==e&&(this.options.range.max=t)
				},
				setFixed:function(t){
					this.options.fixed=t,
					this.calendar&&this._position_calendar_near(this.input.getElement())
				},
				isShown:function(){
					return this.calendar&&""===this.calendar.style.display
				},
				show:function(t,e){
					if(r.isElementVisible(this.input.getElement())){
						if(r.elementHasClass(document.body,"salsa-calendar-opened")||(document.body.className+=" salsa-calendar-opened"),void 0===t||void 0===e){
							var n=this.input.checkDate();
							n===!1&&(n=new Date);var t=n.getFullYear(),e=n.getMonth()
						}
						if(e<0?(t--,e=11):e>11&&(t++,e=0),null===this.calendar){
							this.calendar=this._get_calendar_structure();
							var i=document.getElementsByTagName("body")[0];
							i.appendChild(this.calendar)
						}
						this.before_show(),
						this._refresh(t,e),
						this.calendar.style.display="",
						r.addEvent(this.scrollable_container,"scroll",function(t){this.isShown()&&this._position_calendar_near(this.input.getElement())}.bind(this)),
						this._position_calendar_near(this.input.getElement())
					}
				},
				_get_calendar_structure:function(){
					var t=document.createElement("div");
					return t.className="salsa-calendar",
					t.className+=this.options.showNextMonth?" salsa-calendar-two-months":"",t
				},
				_position_calendar_near:function(t){
					var e=r.findElementPosition(t);
					this.scrollable_container!==document.body&&(e.top-=this.scrollable_container.scrollTop,this._hide_calendar_on_input_overflow(this.scrollable_container,t,e)),
					"right"===this.options.calendarPosition?(this.calendar.style.top=parseInt(e.top)+"px",this.calendar.style.left=parseInt(e.left+t.offsetWidth)+"px",r.elementHasClass(this.calendar,"sc-right")||(this.calendar.className+=" sc-right")):
					"left"===this.options.calendarPosition?(this.calendar.style.top=parseInt(e.top)+"px",this.calendar.style.left=parseInt(e.left-this.calendar.offsetWidth)+"px",r.elementHasClass(this.calendar,"sc-left")||(this.calendar.className+=" sc-left")):
					(this.calendar.style.top=parseInt(e.top+t.offsetHeight)+"px",this.calendar.style.left=parseInt(e.left)+"px",r.elementHasClass(this.calendar,"sc-bottom")||(this.calendar.className+=" sc-bottom")),
					this.calendar.style.position=this.options.fixed?"fixed":"absolute"
				},
				_hide_calendar_on_input_overflow:function(t,e,n){
					var i=r.findElementPosition(t),
					a=n.top-i.top-t.offsetTop+e.clientHeight;
					a>t.offsetHeight&&this.hide(),
					n.top<i.top&&this.hide()
				},hide:function(){this.calendar&&(this.calendar.style.display="none"),document.body.className=document.body.className.replace(" salsa-calendar-opened","")},hideOthers:function(){
					for(var t=r.getElementsByClassName(document,"salsa-calendar"),e=0;e<t.length;e++)t[e]!==this.calendar&&(t[e].style.display="none")
				},
				_refresh:function(t,e){
					this.calendar.innerHTML="";
					var n=this._build_calendar_page(t,e,!1);
					if(this.calendar.appendChild(n),this.options.showNextMonth){
						11===e?(t++,e=0):e++;
						var n=this._build_calendar_page(t,e,!0);
						this.calendar.appendChild(n)
					}
				},
				_build_calendar_page:function(t,e,n){
					var i=document.createElement("table");
					i.setAttribute("cellspacing",0,!1),i.setAttribute("cellpadding",0,!1),i.appendChild(this._get_header(t,e,n));
					var a=document.createElement("tbody");
					i.appendChild(a);
					for(var s=new Date(t,e,1),r=0;r<6;r++){
						var o=document.createElement("tr");
						a.appendChild(o);
						for(var l=0;l<7;l++){
							var h=document.createElement("td"),c=(l+this.i18n.getFirstDayOfWeek())%7;
							s.getMonth()===e&&s.getDay()===c?(h.className="sc-day sc-keep-open",
								this.getCurrentDate()&&this.getCurrentDate().getTime()===s.getTime()&&(h.className+=" sc-current"),
								this._is_today(s)&&(h.className+=" sc-today"),
								this.inRangeDate(s)?function(t){
									h.onclick=function(){
										this.input.setDate(t),
										this.setCurrentDate(t),
										this.hide(),
										this.options.onSelect(this.input.getElement()),this.on_date_click()
									}
									.bind(this)
								}
								.bind(this)(new Date(s.getTime())):h.className+=" sc-disabled",h.innerHTML=s.getDate(),s.setDate(s.getDate()+1)):h.className="sc-other-month",o.appendChild(h)
						}
					}
					return i
				},
				_is_today:function(t){var e=new Date;return t.getDate()===e.getDate()&&t.getMonth()===e.getMonth()&&t.getFullYear()===e.getFullYear()
				},
