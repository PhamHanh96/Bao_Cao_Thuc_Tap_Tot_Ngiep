...
(function (factory) {
    ...
    var BarRating = (function () {
        ...
        function BarRating() {
            ...
            var findInitialOption = function findInitialOption() {
                var option;
            ...
            var isDeselectable = function isDeselectable() {
            ...
            var applyStyle = function applyStyle($w) {
                // remove classes
                $w.find('a').removeClass('br-selected br-current');

                // add classes
                $w.find('a[data-rating-value="' + ratingValue() + '"]').addClass('br-selected br-current')[nextAllorPreviousAll()]().addClass('br-selected');
            };

            // handle click events
            var attachClickHandler = function attachClickHandler($all) {
                $all.on('click', function (event) {
                    ...
                    // onSelect callback
                    self.options.onSelect.call(self, ratingValue(), ratingText(), event);
            ...
            var attachMouseEnterHandler = function attachMouseEnterHandler($all) {
                $all.on({
            ...
            var attachMouseLeaveHandler = function attachMouseLeaveHandler($all) {
                self.$widget.on({
            ...
            var fastClicks = function fastClicks($all) {
            ...
            // disable clicks
            var disableClicks = function disableClicks($all) {
                $all.on('click', function (event) {
                    event.preventDefault();
                });
            };
